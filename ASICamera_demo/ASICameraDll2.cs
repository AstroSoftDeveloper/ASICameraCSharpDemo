...
namespace ZWOptical.ASISDK
{
    public class ASICameraDll2
    {
        ...
        public struct ASI_SN
        {
            ...
            public string SN
            {
                get 
                {
                    ...
                    {
                        builder.Append(string.Format("{0:X2}", sn[i]));
                    }
        ...
        private static extern ASI_ERROR_CODE ASIGetSerialNumber32(int iCameraID, out ASI_SN pSN);

        [DllImport("ASICamera2_x64.dll", EntryPoint = "ASIGetSerialNumber", CallingConvention = CallingConvention.Cdecl)]
        private static extern ASI_ERROR_CODE ASIGetSerialNumber64(int iCameraID, out ASI_SN pSN);
        ...
        public static ASI_ERROR_CODE ASISetControlValue(int iCameraID, ASI_CONTROL_TYPE ControlType, int lValue, ASI_BOOL bAuto)
        { return IntPtr.Size == 8 /* 64bit */ ? ASISetControlValue64(iCameraID, ControlType, lValue, bAuto) : ASISetControlValue32(iCameraID, ControlType, lValue, bAuto); }

        public static ASI_ERROR_CODE ASIGetControlValue(int iCameraID, ASI_CONTROL_TYPE ControlType, out int plValue)
        {
            ASI_BOOL pbAuto;
            return IntPtr.Size == 8 /* 64bit */ ? ASIGetControlValue64(iCameraID, ControlType, out plValue, out pbAuto) : ASIGetControlValue32(iCameraID, ControlType, out plValue, out pbAuto); 
        }
        ...
        public static ASI_ERROR_CODE ASIGetSerialNumber(int iCameraID, out ASI_SN pSN)
        { return IntPtr.Size == 8 /* 64bit */ ? ASIGetSerialNumber64(iCameraID, out pSN) : ASIGetSerialNumber32(iCameraID, out pSN); }
    }
